...
Security fixes are provided for **currently supported release lines** of `switon/throttle` (`switon/throttle` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/throttle/security/advisories/new)
